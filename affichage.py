...
class affichage:
    ...
    def __init__(self,x_p,y_p,rows,columns):
        ...
        self.__root.bind("<KeyPress-Up>",self.zPress)
        self.__root.bind("<KeyPress-s>",self.sPress)
        self.__root.bind("<KeyPress-Down>",self.sPress)
        self.__root.bind("<KeyPress-q>",self.qPress)
        self.__root.bind("<KeyPress-Left>",self.qPress)
        self.__root.bind("<KeyPress-d>",self.dPress)
        self.__root.bind("<KeyPress-Right>",self.dPress)
